                ...
                <div className={`col-lg-6 ${isRTL ? 'order-lg-2' : 'order-lg-1'}`}>
                    <div className="d-flex flex-column h-100 gap-4">
                        <div className="d-flex flex-grow-1 gap-4">
                            ...
                            <img src="/assets/images/about1.png" className={`img-fluid w-50 ${styles.image}`} alt="About 2" />
                        </div>
                        <div className="d-flex flex-grow-1 gap-4">
                            <img src="/assets/images/about1.png" className={`img-fluid w-50 ${styles.image}`} alt="About 3" />
                            <img src="/assets/images/about1.png" className={`img-fluid w-50 ${styles.image}`} alt="About 4" />
                        </div>
                    </div>
                </div>
